...
Public Class frmBuscarProductoCredito
    ...
    Private Sub lbltitulo_MouseMove(sender As Object, e As MouseEventArgs) Handles lbltitulo.MouseMove
        ...
        SendMessage(Me.Handle, &H112&, &HF012&, 0)
    End Sub
    Private Sub frmBuscarProductoCredito_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call buscarProducto("")
    End Sub
    ...
    Private Sub btnSeleccionar_Click(sender As Object, e As EventArgs) Handles btnSeleccionar.Click
        Dim frm As frmVentaCredito = CType(Owner, frmVentaCredito)
