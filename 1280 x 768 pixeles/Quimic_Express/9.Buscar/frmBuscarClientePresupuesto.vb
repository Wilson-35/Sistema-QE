...
Public Class frmBuscarClientePresupuesto
    Public frmOrigen As String
    Dim adaptador As MySqlDataAdapter
    Dim datos As DataSet
    Private Sub frmBuscarClientePresupuesto_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call buscarCliente(" ")
    End Sub
    ...
    Private Sub btnSeleccion_Click(sender As Object, e As EventArgs) Handles btnSeleccionar.Click
        Dim frmx As frmVentaPresupuesto = CType(Owner, frmVentaPresupuesto)
