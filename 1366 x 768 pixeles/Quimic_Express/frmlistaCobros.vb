...
Public Class frmlistaCobros
    ...
    Private Sub optidcredito_OnChange(sender As Object, e As EventArgs)
        txtBuscar.Focus()
    End Sub

    Private Sub optidventa_OnChange(sender As Object, e As EventArgs)
        txtBuscar.Focus()
    End Sub

    Private Sub optfecha_OnChange(sender As Object, e As EventArgs)
        txtBuscar.Focus()
    End Sub
