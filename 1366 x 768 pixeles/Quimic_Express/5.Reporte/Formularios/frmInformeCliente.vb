...
Public Class FrmInformeCliente
    ...
    Private Sub FrmInformeCliente_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub cargarInforme(condicion As String)
        ...
        Catch ex As MySqlException
            MsgBox(ex.Message)
        End Try
        rptContenedor.LocalReport.ReportEmbeddedResource = "Quimic_Express.rptCliente.rdlc"
        Dim rptDataSet As New ReportDataSource("cd_cliente", datos.Tables("xCliente"))
