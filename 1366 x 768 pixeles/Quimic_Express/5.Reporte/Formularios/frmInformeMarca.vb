...
Public Class FrmInformeMarca
    ...
    Private Sub FrmInformeMarca_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub cargarInforme(condicion As String)
        ...
        Else
            sql = "select * from marca where " & condicion
        End If
        Try
            abrirConexion()
        ...
        Catch ex As MySqlException
            MsgBox(ex.Message)
        End Try
        rptContenedor.LocalReport.ReportEmbeddedResource = "Quimic_Express.RptMarca.rdlc"
        Dim rptDataSet As New ReportDataSource("cd_marca", datos.Tables("xMarca"))
