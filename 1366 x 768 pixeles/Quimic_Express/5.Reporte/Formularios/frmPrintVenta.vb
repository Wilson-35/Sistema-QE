...
Public Class frmPrintVenta

    Private Sub frmPrintVenta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub imprimirVenta(idVenta As String)
        ...
        Try
            ...
            sql = "select * from v_venta where id=" + idVenta
            adaptador = New MySqlDataAdapter(sql, conexion)
            dsVenta = New DataSet
            adaptador.Fill(dsVenta, "xventa")
            'consulta para la vista v_ventaitems
            sql = "Select * from v_ventaitems where idventa= " + idVenta
            adaptador = New MySqlDataAdapter(sql, conexion)
        ...
        Catch ex As MySqlException
            MsgBox(ex.Message)
        End Try
        contenedorRPT.LocalReport.ReportEmbeddedResource = "Quimic_Express.rptVenta.rdlc"
