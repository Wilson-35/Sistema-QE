...
Public Class FrmInformeProveedor
    ...
    Private Sub FrmInformeProveedor_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub cargarInforme(condicion As String)
        ...
        Else
            sql = "select * from proveedor where " & condicion
        End If
        Try
            abrirConexion()
        ...
        Catch ex As MySqlException
            MsgBox(ex.Message)
        End Try
        rptContenedor.LocalReport.ReportEmbeddedResource = "Quimic_Express.RptProveedor.rdlc"
        Dim rptDataSet As New ReportDataSource("cd_proveedor", datos.Tables("xProveedor"))
