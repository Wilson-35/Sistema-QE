...
Public Class frmConsultarCotización
    ...
    Public Sub AbrirFormInPanel(ByVal Formhijo As Object)
        ...
        fh.Show()
    End Sub
    Private Sub frmConsultarCotización_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call cargarRegistros("")
    End Sub
    Public Sub cargarRegistros(condicion As String)
        Dim sql As String
        datos = New DataSet
        sql = "SELECT * FROM cotizacion " & condicion
    ...
    Private Sub ejecutarConsulta()
        ...
        If optUsuario.Checked Then
            condicion = " where Usuario like '%" & txtBuscar.Text & "%'"
        End If
    ...
    Private Sub btnEliminar_Click(sender As Object, e As EventArgs) Handles btnEliminar.Click
        ...
        Try
            If MsgBox("Desea eliminar el registro", vbYesNo, "Confirmar") = MsgBoxResult.Yes Then
                sql = "delete from cotizacion where id_Cotización=" & codigo
                abrirConexion()
