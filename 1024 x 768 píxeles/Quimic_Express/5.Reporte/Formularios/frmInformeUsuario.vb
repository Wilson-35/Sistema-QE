...
Public Class FrmInformeusuario
    ...
    Private Sub FrmInformeUsuario_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub cargarInforme(condicion As String)
        ...
        Else
            sql = "select * from usuario where " & condicion
        End If
        Try
            abrirConexion()
        ...
        Catch ex As MySqlException
            MsgBox(ex.Message)
        End Try
        rptContenedor.LocalReport.ReportEmbeddedResource = "Quimic_Express.rptUsuario.rdlc"
        Dim rptDataSet As New ReportDataSource("cd_usuario", datos.Tables("xUsuario"))
