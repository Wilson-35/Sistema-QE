...
Public Class FrmInformeDeudores
    ...
    Private Sub FrmInformeDeudores_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub cargarInforme(condicion As String)
        ...
        Dim sql As String
        If condicion = "" Then
            sql = "select * from consultadeudoresinforme"
        Else
            sql = "select * from consultadeudoresinforme where " & condicion
        End If
        Try
            abrirConexion()
        ...
        Catch ex As MySqlException
            MsgBox(ex.Message)
        End Try
        rptContenedor.LocalReport.ReportEmbeddedResource = "Quimic_Express.rptDeudores.rdlc"
        Dim rptDataSet As New ReportDataSource("cd_deudores", datos.Tables("xDeudores"))
