...
Public Class FrmInformeAlmacen
    ...
    Private Sub FrmInformeAlmacen_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub cargarInforme(condicion As String)
        ...
        Dim sql As String
        If condicion = "" Then
            sql = "select * from consultaalmacen"
        Else
            sql = "select * from consultaalmacen where " & condicion
        End If
        Try
            abrirConexion()
        ...
        Catch ex As MySqlException
            MsgBox(ex.Message)
        End Try
        rptContenedor.LocalReport.ReportEmbeddedResource = "Quimic_Express.RptAlmacen.rdlc"
        Dim rptDataSet As New ReportDataSource("cd_almacen", datos.Tables("xAlmacen"))
