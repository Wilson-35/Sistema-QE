...
Public Class frmPrintVentaPresupuesto

    Private Sub frmPrintVentaPresupuesto_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub imprimirVenta(idVenta As String)
        ...
        Try
            ...
            sql = "select * from v_venta_presupuesto where id=" + idVenta
            adaptador = New MySqlDataAdapter(sql, conexion)
            dsVenta = New DataSet
            adaptador.Fill(dsVenta, "xventa")
            'consulta para la vista v_ventaitems
            sql = "Select * from v_ventaitemspresupuesto where idventa= " + idVenta
            adaptador = New MySqlDataAdapter(sql, conexion)
        ...
        Catch ex As MySqlException
            MsgBox(ex.Message)
        End Try
        contenedorRPT.LocalReport.ReportEmbeddedResource = "Quimic_Express.rptVentaPresupuesto.rdlc"
        Dim reportDS As New ReportDataSource("cdVenta", dsVenta.Tables("xventa"))
