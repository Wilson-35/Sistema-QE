...
Public Class frmInformeGastos
    ...
    Private Sub FrmInformeGastos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub cargarInforme(condicion As String)
        ...
        Dim sql As String
        If condicion = "" Then
            sql = "select * from consultagastosinforme"
        Else
            sql = "select * from consultagastosinforme where " & condicion
        End If
        Try
            abrirConexion()
            adaptador = New MySqlDataAdapter(sql, conexion)
            datos = New DataSet
            adaptador.Fill(datos, "xGastos")
        ...
        Catch ex As MySqlException
            MsgBox(ex.Message)
        End Try
        rptContenedor.LocalReport.ReportEmbeddedResource = "Quimic_Express.rptGastos.rdlc"
        Dim rptDataSet As New ReportDataSource("cd_Gasto", datos.Tables("xGastos"))
